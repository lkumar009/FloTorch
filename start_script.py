...
if __name__ == "__main__":
    input_data = {
        "experiment_id": "0UCVSKFW", #"UMETZV8I", #"PY060RL0", #"FWBRXDSA", #"5V6JT23B",#"C6Y0PSUT", #"6WPLIHNR", #"7V12HSC7", #"YYJGYJXN", #"TVHXG9A5", #"B0DEORPK", #"NT55FKA1", #"91CRY9AI", #"GMHO3NPF", #"HCTBWVL8", #"ZWSZ9V7E", #"HCTBWVL8", #"D85JMXFL", #"SDSJEGBF", #"YTMIYMV5", #"1S9WGU7L", #"10HXLV8K", #"KRN4IHMP", #"G0YX7GTR", #"3816GTGE", #"U7OIODQ4", #"NYXKGO0B", #"X4138KRW", #"MMN5SF0D", #"TIK045O5", #"ZWSZ9V7E", #"OVUBX9SQ", #evaluation - #"2H2AOWFH", #"POCFEEOA", #"946RI6BP"
        "execution_id": "3V4BP", #"KURRH", #"50UQ1", #"ZUNWC",#"VGRXZ",#"NYCZW", #"6V32X",#"50UQ1",#"XJFHM",#"7L2EH", #"50UQ1",
        ...
        "llm_based_eval": "True", 
        "eval_service": "ragas",
        "eval_embedding_model": "amazon.titan-embed-text-v2:0", #"amazon.titan-embed-text-v1", #"amazon.nova-pro-v1:0",
    ...
    print("Evaluation Execution time in Seconds: ", sec)
    print("Evaluation Execution time in Minutes: ", round(sec/60))
